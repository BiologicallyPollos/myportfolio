    ...
    <main className="min-h-screen bg-[#021509] text-white overflow-x-hidden selection:bg-emerald-500/30">
      ...
      <div className="py-32 relative z-10">
        <motion.div {...slideUp} className="max-w-4xl mx-auto px-6 mb-16 text-center">
          <h2 className="text-xs font-medium tracking-[0.4em] text-emerald-500 uppercase mb-8">Video</h2>
      ...
      <div className="max-w-5xl mx-auto px-6 space-y-48 pb-48 relative z-10">
        ...
        <motion.section {...slideUp} className="space-y-16">
          <div className="text-center">
            <h2 className="text-xs font-medium tracking-[0.4em] text-emerald-500 uppercase mb-4">Speeches</h2>
          </div>
          <div className="grid md:grid-cols-2 gap-8 text-left">
            {[
              ...
              <div key={i} className="p-10 rounded-[2rem] bg-white/[0.03] border border-white/5 hover:bg-white/[0.05] transition-all">
        ...
        <motion.section {...slideUp} className="space-y-16 text-center">
          <h2 className="text-xs font-medium tracking-[0.4em] text-emerald-500 uppercase">Writing</h2>
        ...
        <footer className="pt-24 flex flex-col items-center border-t border-white/5">
          <a href="https://linkedin.com/in/your-profile" target="_blank" className="px-12 py-6 bg-white text-[#021509] rounded-full font-bold hover:scale-105 transition-all shadow-xl">
            Connect on LinkedIn
          </a>
